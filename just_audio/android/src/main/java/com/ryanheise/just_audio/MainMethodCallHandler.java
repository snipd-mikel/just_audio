...
public class MainMethodCallHandler implements MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, @NonNull Result result) {
        ...
        case "init": {
            ...
            players.put(id, new AudioPlayer(applicationContext, messenger, id, call.argument("audioLoadConfiguration"), rawAudioEffects, call.argument("androidOffloadSchedulingEnabled"), call.argument("userAgent")));
            result.success(null);
            break;
        }
        case "disposePlayer": {
